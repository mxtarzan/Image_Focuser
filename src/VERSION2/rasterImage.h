...
typedef	struct ImageStruct {
	...
	ImageStruct(void) = delete;
	ImageStruct(const ImageStruct& obj) = delete;
	ImageStruct(ImageStruct&& obj) = delete;
	ImageStruct& operator=(ImageStruct&& obj) = delete;
	...
	ImageStruct(unsigned int theWidth, unsigned int theHeight, ImageType theType,
